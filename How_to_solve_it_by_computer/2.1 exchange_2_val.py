...
a = 721
b = 463
a = b # Step 1: a = b = 463 (new value of a), old value of a is lost
b = a # Step 2: b = 463 (new value of a)

new value of b = new value of a
(b = a = 463, old value of a = 721 is lost)
It means that we should find a way to keep the old value of a and not to lose it, i.e to store value of A in a temporary variable before losing in
in Step 1
"""
a = 721
b = 463
